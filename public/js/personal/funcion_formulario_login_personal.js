...
function setLoadingFormularioLogin(button, isLoading) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (event) => {
        ...
        setLoadingFormularioLogin(button, true);//---Activa el spinner
        ...
        try {
            ...
            setLoadingFormularioLogin(button, false);
        }
    });
});