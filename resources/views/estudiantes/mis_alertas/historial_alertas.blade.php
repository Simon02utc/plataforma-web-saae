...
@section('content')
    ...
    <div class="contenedor-principal-seccion">
        ...
        <div class="contenedor-titulos-secciones">
            <h1>Historial de alertas de asistencia</h1>
        </div>

        <div class="contenedor">
            <h2 class="titulo-contenedor"><span>Historial de alertas</span></h2>

            <p class="texto-contenedor">Se muestran las alertas de asistencia que ya fueron <b>atendidas o cerradas</b>.</p>
                ...
                <div class="contenedor-tablas-contenido">
                    ...
                    <div class="contenedor-botones-accion-tabla">
                        ...
                        <div class="contenedor-buscador-tabla">
                            <input type="text" id="input-buscar-historial-alertas" class="input-buscar-tabla" placeholder="Buscar por No. control o Nombre">
                    ...
                    <div class="tabla-scroll">
                        <div class="contenedor-tabla">
                            <table
                                ...
                                data-url-tabla-historial-alertas="{{ route('grup_estudiante.grup_alertas.name_historial_alertas_tabla') }}"
                                data-url-resumen-historial-alertas="{{ route('grup_estudiante.grup_alertas.name_historial_alertas_resumen') }}"
                                data-url-ver-alerta="{{ route('grup_estudiante.grup_alertas.name_ver_alerta', ['id' => '__ID__']) }}"
                            >
                                <thead>
                                    <tr>
...
@push('scripts')
    <script src="{{ asset('js/estudiantes/mis_alertas/funcion_tabla_historial_alertas.js') }}"></script>
@endpush