...
@section('content')
    ...
    <div class="content-banner-pagina">
        ...
        <a class="btn-accion-banner" href="{{ route('grup_personal.name_login_personal') }}">
            Iniciar sesión
        </a>
    </div>
    ...
    <div class="contenedor-restablecer-contrasena">
        ...
        <form id="form-restablecer-contrasena-personal" method="POST" action="{{ route('grup_personal.actualizar_contrasena_personal') }}">
            @csrf
...
@push('scripts')
    <script src="{{ asset('js/personal/restablecer_contrasena_personal/funcion_restablecer_contraseña_personal.js') }}"></script>
