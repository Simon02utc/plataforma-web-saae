<div id="modal-recuperar-contrasena-estudiante" class="modal-recuperar-contrasena">
    <div class="contenedor-modal-recuperar-contrasena">
        ...
        <form id="form-recuperar-contrasena-estudiante" method="POST" action="{{ route('grup_estudiante.enviar_correo_enlace_recuperacion_contrasena_estudiante') }}" accept-charset="UTF-8">
            @csrf

            <div class="form-inputs">
                <div class="input-box">
                    <input type="email" name="email" class="input-field input-field-contra" placeholder="ejemplo@cenidet.tecnm.mx" title="Su correo debe ser válido" autocomplete="off" required>
